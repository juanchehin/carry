							...
							<div class="card-body">
								<div class="lh-1">
									...
									<div class="input-group input-sm">
										<span class="input-group-text rounded-0">Cantidad</span>
										<input type="number" class="form-control rounded-0 text-center" id="quantity" name="quantity" value="1" required="required">
									</div>
									<input type="submit" name="add" style="margin-top:5px;" class="btn btn-primary btn-sm rounded-0" value="Agregar Carrito">
									</div>
								</div>
							</div>
